...
from sdx_gcp import Flask, Request
...
def deliver_legacy(req: Request):
    """
...
def deliver_hybrid(req: Request):
    """
...
def deliver_feedback(req: Request):
    """
...
def deliver_comments(req: Request):
    """
