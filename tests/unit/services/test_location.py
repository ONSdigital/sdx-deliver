...
NIFI_LOCATION_NS2: Final[str] = "ns2_location_name"
...
class LocationNameSettings:
    ...
    nifi_location_ns2 = NIFI_LOCATION_NS2
...
class TestLocationService(unittest.TestCase):
    ...
    def test_lookup_ftp(self: Self):
        expected: LocationKey = {"location_type": WINDOWS_SERVER, "location_name": NIFI_LOCATION_FTP}
    ...
    def test_lookup_sdx(self: Self):
        expected: LocationKey = {"location_type": GCS, "location_name": "test-bucket"}
    ...
    def test_lookup_spp(self: Self):
        expected: LocationKey = {"location_type": S3, "location_name": NIFI_LOCATION_SPP}
    ...
    def test_lookup_dap(self: Self):
        expected: LocationKey = {"location_type": WINDOWS_SERVER, "location_name": NIFI_LOCATION_DAP}
