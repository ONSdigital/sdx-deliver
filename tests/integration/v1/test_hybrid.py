...
from app.routes import FILE_NAME, VERSION, V2, SUBMISSION_FILE, MESSAGE_SCHEMA, V1, deliver_hybrid, TRANSFORMED_FILE
...
class HybridTest(unittest.TestCase):
    ...
    def test_hybrid(self,
        ...
        output_filename = f'{input_filename}:hybrid'
        survey_id = "002"
        period_id = "202505"
        ru_ref = "49900000001A"
        ...
        with zipfile.ZipFile(zip_buffer, 'w', zipfile.ZIP_DEFLATED) as zip_file:
            ...
            zip_file.writestr("fake_spp_name", "This is the content of the spp json file.")
        ...
        # Call the endpoint
        response = deliver_hybrid(MockRequest(data), tx_id)
